...
"""
Main Call. acts as the main menu for the program
"""
def main_menu():
	os.system('clear')
	...
	click.echo('-  Version 0.4.1: 26/03/2021')
	...
	choices = ["[1] Aquire A New Image", "[2] Analyse Exsisting Image", "[3] Settings", '[4] Extras', "[0] Exit"]
